    ...
    <>
      ...
      <div className="container">
        <Routes>
          ...
          <Route path="/" element={<div className="mt-5"><h1 className="display-4 text-center text-primary">Welcome to Octofit Tracker!</h1><p className="lead text-center">Track your fitness, join teams, and compete on the leaderboard.</p></div>} />
        </Routes>
      </div>
    </>
  );
